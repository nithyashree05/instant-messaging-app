...
image1=PhotoImage(file="./login.png",master=login_window)
...
loginButton=Button(login_window,text='Login',font=('Open Sans',17,'bold'),bg='#57a1f8',fg='#fff',activebackground='#57a1f8',activeforeground='#fff',command=sign)
